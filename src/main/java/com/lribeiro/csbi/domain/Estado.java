...
public class Estado implements Serializable {
	...
	@JsonIgnore
	@OneToMany(mappedBy="estado")										//Inverso da Cidade, pois é somente um estados (classe atual) para várias cidades (atributo)
	private List<Cidade> cidades = new ArrayList<>();					//Um estado pode ter várias cidades
