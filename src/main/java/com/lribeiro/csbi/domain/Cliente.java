...
public class Cliente implements Serializable {
	...
	private Set<String> telefones = new HashSet<>();													//Set é uma colecao que não permite repetição
	...
	public TipoCliente getTipo() {
		return TipoCliente.toEnum(tipo);											//Uso do método estatico criado na classe TipoCliente
	}
